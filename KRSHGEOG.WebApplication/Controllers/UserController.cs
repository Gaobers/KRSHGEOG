...
using KRSHGEOG.BusinessLogic.UseCases.Users.Queries.GetUserAuthenticated;
using Microsoft.AspNetCore.Mvc.Rendering;
using Mapster;
using KRSHGEOG.BusinessLogic.UseCases.Users.Commands.CreateUser;
using KRSHGEOG.BusinessLogic.UseCases.Users.Queries.GetUser;
using KRSHGEOG.BusinessLogic.UseCases.Users.Commands.UpdateUser;
using KRSHGEOG.BusinessLogic.UseCases.Users.Queries.GetUsers;
using KRSHGEOG.BusinessLogic.UseCases.Users.Queries.GetRoles;
...
namespace KRSHGEOG.WebApplication.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(IMediator mediador)
        {
            _mediator = mediador;
        }
